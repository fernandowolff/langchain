...
class DadosDeEstudante(BaseTool):
    ...
    description = """Esta ferramenta extrai o histórico e as preferências de um estudante de acordo com seu histórico. Passe para essa ferramenta como argumento o nome do estudante."""

    # A ferramenta já recebe o nome do estudante como input(extraido da pergunta pela propria LLM). Pedir para ela extrair o nome do nome, pode faze-la alucinar muito, e é um gasto desnecessário.
    def _run(self, input: str) -> str:
        ...
        template = PromptTemplate(template="""
            Você deve analisar a entrada a seguir e extrair o nome da pessoa informada em minúsculo.
            Entrada: 
            -----------
            {input}
            -----------
        ...
        dados = self.busca_dados_de_estudante(estudante)
...
class PerfilAcademico(BaseTool):
    ...
    description = """
        ...
        Esta ferramente requer como entradas todos os dados do estudante.
